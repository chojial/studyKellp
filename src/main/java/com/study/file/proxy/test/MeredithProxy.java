 ...
 * 用来生产源码的工具类
 */
public class MeredithProxy {

    public static final String ln ="\r\n";

    public static Object newProxyInstance(MeredithClassLoader classLoader,Class<?>[] interfaces,
                                          MeredithInvocationHandler h){
        try{
            //1.动态生成源码.java文件

            String src = generateSrc(interfaces);
            //2.Java文件输出磁盘
            String filePath = MeredithProxy.class.getResource("").getPath();
            ...
            Constructor c = proxyClass.getConstructor(MeredithInvocationHandler.class);
            f.delete();
    ...
    private static String generateSrc(Class<?>[] interfaces){
        ...
        sb.append(MeredithProxy.class.getPackage() + ";" + ln);
        sb.append("import " + interfaces[0].getName() + ";" + ln);
        sb.append("import java.lang.reflect.*;" + ln);
        sb.append("public class $Proxy0 implements " + interfaces[0].getName() + "{" + ln);
        sb.append("MeredithInvocationHandler h;" + ln);
        sb.append("public $Proxy0(MeredithInvocationHandler h){ " + ln);
        sb.append("this.h = h;");
        sb.append("}" + ln);
